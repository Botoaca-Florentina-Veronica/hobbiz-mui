...
const PrivacyPolicy = () => (
  <div className="privacy-policy">
    ...
    <div className="privacy-policy__infobox">
      <span className="privacy-policy__infobox-icon" role="img" aria-label="info">ℹ️</span>
      <div>
        <strong>Transparență și protecție a datelor</strong>
        <p>
          La Hobbiz, considerăm protecția datelor personale o responsabilitate fundamentală. Acest documen descrie în detaliu practicile noastre de gestionare a informațiilor, conform Regulamentului General privind Protecția Datelor (GDPR) și legislației românești aplicabile. Prin utilizarea platformei noastre, confirmi că ai citit și înțeles aceste practici.
        </p>
      </div>
    </div>
    ...
    <section>
        ...
        <p>
            - Folosiți parole complexe și unice pentru contul Hobbiz<br />
            - Activați autentificarea cu doi factori în setările contului<br />
            - Actualizați periodic adresa de email și numărul de telefon de recuperare<br />
            - Evitați accesul contului din rețele Wi-Fi publice neprotejate<br />
            - Verificați periodic activitatea contului în secțiunea de securitate
        </p>
        ...
        <p>
            - ISO 27001 pentru managementul securitării informațiilor<br />
            - SOC 2 Type II pentru controalele de securitate și confidențialitate<br />
            - PCI DSS pentru procesarea plăților (nivel 1)<br />
            - GDPR prin audituri regulate efectuate de firme de specialitate
        </p>
